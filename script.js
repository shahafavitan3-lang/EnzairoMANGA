...
const translations = {
  he: {
    ...
    toast_volume_created: 'הכרך נוצר בהצלחה.',
  ...
  en: {
    ...
    toast_volume_created: 'Volume created successfully.',
...
const STORAGE_KEY = 'enzairo_site_data_v4';
const STORAGE_RESET_KEY = 'enzairo_clean_start_v4';
